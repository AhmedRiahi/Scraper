...
public class JMSTopics {
    ...
    public static class Analytics {
        public static final String ANALYSE_STANDALONE_DESCRIPTOR_POPULATION = "analytics.analyse_standalone_descriptor_population" + ENV;
        public static final String ANALYSE_JOINED_DESCRIPTOR_POPULATION = "analytics.analyse_joined_descriptor_population" + ENV;
        public static final String ANALYSE_JOINER_DESCRIPTOR_POPULATION = "analytics.analyse_joiner_descriptor_population" + ENV;
