...
public class AnalyticsReceiver {
	...
	@JmsListener(destination = KafkaTopics.Analytics.ANALYSE_STANDALONE_DESCRITOR_POPULATION+KafkaTopics.IN)
	...
	@JmsListener(destination = KafkaTopics.Analytics.ANALYSE_JOINED_DESCRITOR_POPULATION+KafkaTopics.IN)
	...
	@JmsListener(destination = KafkaTopics.Analytics.ANALYSE_JOINER_DESCRITOR_POPULATION+KafkaTopics.IN)
	...
	@JmsListener(destination = KafkaTopics.Analytics.ANALYSE_INDIVIDUAL+KafkaTopics.IN)
